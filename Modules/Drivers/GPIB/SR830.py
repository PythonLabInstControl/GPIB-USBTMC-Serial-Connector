...
#Instrument status
    ...
    def SerialPollDiagnostic(self):
        ...
        if (not ok):
            ...
            if SPBbit4:
                self.communicator.write('REST') # not shure that this will help
            if SPBbit5:
