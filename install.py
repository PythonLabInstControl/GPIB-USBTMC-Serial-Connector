...
os.system("sudo apt-get -y install linux-headers-$(uname -r) python-numpy usbutils build-essential make gcc python kernel-package texinfo texi2html libcwidget-dev libncurses5-dev libx11-dev binutils-dev bison flex libusb-1.0-0 libusb-dev libmpfr-dev libexpat1-dev tofrodos subversion autoconf automake libtool python-dev python2.7-dev fxload build-essential bzip2 libbz2-dev sqlite3 libsqlite3-dev libssl-dev git")
